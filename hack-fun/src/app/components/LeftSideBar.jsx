...
const LeftSideBar = ({ userName }) => {
  ...
  return (
    <nav className="leftsidebar bg-dark-2 fixed flex-col flex min-h-screen -mr-3.5">
      <div className="flex flex-col gap-11 flex-grow">
        ...
        <div className="flex items-center justify-center hover:text-indigo-500 block mb-4 mr-15">
          <FontAwesomeIcon
