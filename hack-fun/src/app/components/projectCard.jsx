            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-dark-2 shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                        ...
                        <a href="https://docs.google.com/document/d/e/2PACX-1vSC4-YfIvlgggRmPM-jlvKjF_o41ZBYcraKvO-8AKeEMhyeS4yMmCaSf9pyavsw3MzpHPvONz-OZIhj/pub" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-dark-2 shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                        ...
                        <a href="https://docs.google.com/document/d/e/2PACX-1vRa4v7rAZWZpBs0R_kH_mPpPl788cY9wDILKJkJL6ieKrU2jtsK_9demcudSFDFSU5uAQ30TEM9ENt8/pub" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Access Project Brief
                        </a>
                    </div>
                </div>
